...
import bin from '../Component/images/trash.png'
import page  from '../Component/images/39949.png'
import edits from '../Component/images/edit.png'
                            ...
                            <tbody className='table-group-divider'>
                                {
                                    noRecord ? (
                                        <>
                                            <tr>
                                                <td className='text-center fw-bold pe-0 py-3 fs-3 ' colSpan={6}><img src={page} alt="" className='d-block m-auto' width="150px" />
                                                    Empty Records</td>
                                            </tr>
                                        </>
                                    ) : (
