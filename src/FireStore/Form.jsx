                    ...
                    <div className="col-4 m-auto">
                        <form action="" className='bg-light p-3 bor-rad lightslategrey shadow-lg' onSubmit={handleSubmit}>
                            ...
                            <div className="form-group mb-3">
                                <input type="text" placeholder="Enter Your Name" name='name' value={input ? input.name : ''} onChange={handleChange}></input>
                                <div className='text-danger text-end'>{errors.name}</div>
                            </div>
                            <div className="form-group mt-3 mb-3">
                                <input type="email" placeholder="Enter Your Email" name='email' value={input ? input.email : ''} onChange={handleChange}></input>
